...
Item {
    ...
    readonly property string armMessage:                        qsTr("Kích hoạt thiết bị bay.")
    readonly property string forceArmMessage:                   qsTr("CẢNH BÁO: Điều này sẽ ép kích hoạt thiết bị bay, bỏ qua mọi kiểm tra an toàn.")
    readonly property string disarmMessage:                     qsTr("Tắt thiết bị bay.")
    readonly property string emergencyStopMessage:              qsTr("CẢNH BÁO: ĐIỀU NÀY SẼ DỪNG TẤT CẢ CÁC ĐỘNG CƠ. NẾU THIẾT BỊ BAY ĐANG TRÊN KHÔNG, NÓ SẼ RƠI.")
    readonly property string takeoffMessage:                    qsTr("Cất cánh từ mặt đất và giữ vị trí.")
    readonly property string gripperMessage:                       qsTr("Kẹp hoặc thả hàng hóa.")
    readonly property string startMissionMessage:               qsTr("Cất cánh từ mặt đất và bắt đầu nhiệm vụ hiện tại.")
    readonly property string continueMissionMessage:            qsTr("Tiếp tục nhiệm vụ từ điểm waypoint hiện tại.")
    readonly property string resumeMissionUploadFailMessage:    qsTr("Tải lại nhiệm vụ thất bại. Xác nhận để thử tải lại.")
    readonly property string landMessage:                       qsTr("Hạ cánh thiết bị bay tại vị trí hiện tại.")
    readonly property string rtlMessage:                        qsTr("Quay lại vị trí xuất phát của thiết bị bay.")
    readonly property string changeAltMessage:                  qsTr("Thay đổi độ cao của thiết bị bay lên hoặc xuống.")
    readonly property string changeCruiseSpeedMessage:          qsTr("Thay đổi tốc độ hành trình ngang tối đa.")
    readonly property string changeAirspeedMessage:             qsTr("Thay đổi điểm thiết lập tốc độ không khí tương đương.")
    readonly property string gotoMessage:                       qsTr("Di chuyển thiết bị bay đến vị trí chỉ định.")
             property string setWaypointMessage:                qsTr("Điều chỉnh điểm waypoint hiện tại đến %1.").arg(_actionData)
    readonly property string orbitMessage:                      qsTr("Quay quanh thiết bị bay tại vị trí chỉ định.")
    readonly property string landAbortMessage:                  qsTr("Hủy bỏ chuỗi hạ cánh.")
    readonly property string pauseMessage:                      qsTr("Tạm dừng thiết bị bay tại vị trí hiện tại, điều chỉnh độ cao lên hoặc xuống nếu cần.")
    readonly property string mvPauseMessage:                    qsTr("Tạm dừng tất cả thiết bị bay tại vị trí hiện tại.")
    readonly property string vtolTransitionFwdMessage:          qsTr("Chuyển VTOL sang chế độ bay cánh cố định.")
    readonly property string vtolTransitionMRMessage:           qsTr("Chuyển VTOL sang chế độ bay đa cánh quạt.")
    readonly property string roiMessage:                        qsTr("Làm cho vị trí chỉ định trở thành Vùng ROI.")
    readonly property string setHomeMessage:                    qsTr("Đặt vị trí nhà của thiết bị bay là vị trí chỉ định. Điều này sẽ ảnh hưởng đến vị trí Return to home.")
    ...
    function executeAction(actionCode, actionData, sliderOutputValue, optionChecked) {
        ...
        case actionSetHome:
            ...
            break
        default:
            console.warn(qsTr("Lỗi nội bộ: mã hành động không xác định"), actionCode)
            break
        }
    }
}
