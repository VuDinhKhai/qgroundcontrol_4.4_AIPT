...
Rectangle {
    ...
    Column {
        ...
        QGCLabel {
            ...
            text:                       qsTr("Không có tín hiệu GPS cho thiết bị bay")
        }
        ...
        QGCLabel {
            ...
            color:                      "black"
            font.pointSize:             ScreenTools.largeFontPointSize
            text:                       qsTr("Thiết bị bay đã không vượt qua kiểm tra trước khi bật động cơ. Để bật động cơ, hãy khắc phục sự cố.")
        }
    }
}
