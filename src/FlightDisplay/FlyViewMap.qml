...
FlightMap {
    ...
    MapItemView {
        ...
        delegate: MapQuickItem {
            ...
            sourceItem: MissionItemIndexLabel {
                id:         itemIndexLabel
                label:      qsTr("R", "Nhãn mục bản đồ điểm tập kết")
            }
        }
    }
    ...
    MapQuickItem {
        ...
        sourceItem: MissionItemIndexLabel {
            checked:    true
            index:      -1
            label:      qsTr("Đi đến đây", "Đi đến điểm waypoint vị trí")
        }
    ...
    MapQuickItem {
        ...
        sourceItem: MissionItemIndexLabel {
            checked:    true
            index:      -1
            label:      qsTr("Vùng ROI ở đây", "Làm cho đây trở thành Vùng ROI")
        }
    ...
    MapQuickItem {
        ...
        sourceItem: MissionItemIndexLabel {
            checked:    true
            index:      -1
            label:      qsTr("Quay quanh", "Quay quanh điểm waypoint")
        }
    }
    ...
    Component {
        ...
        ColumnLayout {
            ...
            QGCButton {
                Layout.fillWidth:   true
                text:               qsTr("Đặt vị trí nhà ở đây")
    ...
    Component {
        ...
        EditPositionDialog {
            title:                  qsTr("Chỉnh sửa vị trí Vùng ROI")
