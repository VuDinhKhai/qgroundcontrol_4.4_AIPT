...
ApplicationWindow {
    ...
    function showAnalyzeTool() {
        showTool(qsTr("Công cụ phân tích"), "AnalyzeView.qml", "/qmlimages/Analyze.svg")
    }

    function showSetupTool() {
        showTool(qsTr("Thiết lập phương tiện"), "SetupView.qml", "/qmlimages/Gears.svg")
    }

    function showSettingsTool() {
        showTool(qsTr("Cài đặt ứng dụng"), "AppSettings.qml", "/res/QGCLogoWhite")
    }
        ...
        for (var index=0; index<QGroundControl.multiVehicleManager.vehicles.count; index++) {
            if (QGroundControl.multiVehicleManager.vehicles.get(index).parameterManager.pendingWrites) {
                mainWindow.showMessageDialog(closeDialogTitle,
                    qsTr("Bạn có thông số cập nhật đang chờ xử lý cho một chiếc xe. Nếu bạn đóng bạn sẽ mất các thay đổi. Bạn có chắc chắn muốn đóng không?"),
                    StandardButton.Yes | StandardButton.No,
    ...
    function checkForActiveConnections() {
        if (QGroundControl.multiVehicleManager.activeVehicle) {
            mainWindow.showMessageDialog(closeDialogTitle,
                qsTr("Vẫn có những hoạt động đang kết nối với các phương tiện. Bạn có chắc chắn muốn thoát không?"),
                StandardButton.Yes | StandardButton.No,
                function() { finishCloseProcess() })
        } else {
            finishCloseProcess()
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    SubMenuButton {
                        ...
                        text:               qsTr("Thiết lập phương tiện")
                    ...
                    ColumnLayout {
                        ...
                        QGCLabel {
                            id:                     versionLabel
                            text:                   qsTr("%1 Phiên bản AIPT UAV").arg(QGroundControl.appName)
                        ...
                        QGCLabel {
                            ...
                            QGCMouseArea {
                                ...
                                MessageDialog {
                                    ...
                                    title:              qsTr("Kiểm tra các khu vực cảm ứng")
                                    text:               qsTr("Hiển thị khu vực cảm ứng đã được chuyển đổi")
                                    standardButtons:    StandardButton.Ok
                                }

                                MessageDialog {
                                    id:                 advancedModeOnConfirmation
                                    title:              qsTr("Chế độ nâng cao")
        ...
        background: Rectangle {
            ...
            Rectangle {
                ...
                QGCLabel {
                    ...
                    anchors.centerIn:   parent
                    text:               qsTr("Nhận được các lỗi bổ sung")
                    font.pointSize:     ScreenTools.smallFontPointSize
                    color:              qgcPal.alertText
                }
            }
