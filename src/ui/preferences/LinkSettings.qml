    ...
    Row {
        ...
        QGCButton {
            ...
            MessageDialog {
                ...
                title:      qsTr("Xóa cấu hình liên kết")
                text:       _currentSelection ? qsTr("Xóa %1. Bạn có chắc chắn muốn làm điều này không?").arg(_currentSelection.name) : ""
        ...
        Rectangle {
            ...
            QGCFlickable {
                ...
                ColumnLayout {
                    ...
                    QGCGroupBox {
                        title: originalLinkConfig ? qsTr("Chỉnh sửa cài đặt cấu hình liên kết") : qsTr("Tạo cấu hình liên kết mới")
                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                QGCTextField {
                                    ...
                                    placeholderText:        qsTr("Nhập tên")
                                }

                                QGCCheckBox {
                                    Layout.columnSpan:  2
                                    text:               qsTr("Tự động kết nối khi khởi động")
