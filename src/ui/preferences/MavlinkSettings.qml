        ...
        Column {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    QGCCheckBox {
                        text:       qsTr("Phát tín hiệu heartbeat")
                    ...
                    QGCCheckBox {
                        text:       qsTr("Chỉ chấp nhận MAVs với phiên bản giao thức giống nhau")
                    ...
                    FactCheckBox {
                        ...
                        text:       qsTr("Kích hoạt chuyển tiếp MAVLink")
                   ...
                   QGCLabel {
                        text:       qsTr("<i> Việc thay đổi Host name yêu cầu khởi động lại ứng dụng. </i>")
                        visible:    QGroundControl.settingsManager.appSettings.forwardMavlinkHostName.visible
                    }
                }
            }
            ...
            Item {
                ...
                QGCLabel {
                    id:             streamRatesLabel
                    text:           qsTr("Tỷ lệ dòng dữ liệu telemetry (Chỉ dành cho ArduPilot)")
                    font.family:    ScreenTools.demiboldFontFamily
                }
            }
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    QGCCheckBox {
                        text:               qsTr("Tất cả các dòng dữ liệu được điều khiển bởi cài đặt của thiết bị bay.")
                    ...
                    GridLayout {
                        ...
                        QGCLabel { text:  qsTr("Trạng thái mở rộng") }
                        FactComboBox {
            ...
            Item {
                ...
                QGCLabel {
                    id:             mavStatusLabel
                    text:           qsTr("Trạng thái liên kết MAVLink (Thiết bị bay hiện tại)")
                    font.family:    ScreenTools.demiboldFontFamily
                }
            }
            Rectangle {
                ...
                Column {
                    ...
                    Row {
                        ...
                        QGCLabel {
                            width:              _labelWidth
                            text:               qsTr("Tổng số tin nhắn đã gửi (tính toán):")
                            anchors.verticalCenter: parent.verticalCenter
                        }
                        QGCLabel {
                            width:              _valueWidth
                    ...
                    Row {
                        ...
                        QGCLabel {
                            width:              _labelWidth
                            text:               qsTr("Tổng số tin nhắn đã nhận:")
                            anchors.verticalCenter: parent.verticalCenter
                        }
                        QGCLabel {
                            width:              _valueWidth
                    ...
                    Row {
                        ...
                        QGCLabel {
                            width:              _labelWidth
                            text:               qsTr("Tổng số mất tin nhắn:")
                            anchors.verticalCenter: parent.verticalCenter
                        }
                        QGCLabel {
                            width:              _valueWidth
            ...
            Item {
                ...
                QGCLabel {
                    id:             mavlogLabel
                    text:           qsTr("MAVLink 2.0 Ghi nhật ký (Chỉ dành cho PX4 Pro)")
                    font.family:    ScreenTools.demiboldFontFamily
                }
            }
            Rectangle {
                ...
                Column {
                    ...
                    Row {
                        ...
                        QGCLabel {
                            width:              _labelWidth
                            text:               qsTr("Khởi động/Dừng thủ công:")
                            anchors.verticalCenter: parent.verticalCenter
                        }
                        QGCButton {
                            text:               qsTr("Bắt đầu ghi nhật ký")
                    ...
                    QGCCheckBox {
                        text:       qsTr("Bật ghi nhật ký tự động")
            ...
            Item {
                ...
                QGCLabel {
                    id:             logLabel
                    text:           qsTr("Tải lên nhật ký MAVLink 2.0 (Chỉ PX4 Pro)")
                    font.family:    ScreenTools.demiboldFontFamily
                }
            }
            Rectangle {
                ...
                Column {
                    ...
                    Row {
                        ...
                        QGCLabel {
                            ...
                            text:               qsTr("Địa chỉ email để tải lên nhật ký:")
                        }
                        QGCTextField {
                            id:         emailField
                    ...
                    Row {
                        ...
                        QGCLabel {
                            ...
                            text:               qsTr("URL tải lên mặc định")
                        }
                        QGCTextField {
                            id:         urlField
                    ...
                    Row {
                        ...
                        QGCComboBox {
                            ...
                            model: ListModel {
                                id: windItems
                                ListElement { text: qsTr("Vui lòng chọn"); value: -1 }
                                ListElement { text: qsTr("Calm (lặng gió)");     value: 0 }
                                ListElement { text: qsTr("Breeze (gió nhẹ)");   value: 5 }
                                ListElement { text: qsTr("Gale (gió mạnh)");     value: 8 }
                                ListElement { text: qsTr("Storm (bão)");    value: 10 }
                            }
                            onActivated: {
                                saveItems();
                    ...
                    Row {
                        ...
                        QGCLabel {
                            ...
                            text:               qsTr("Flight Rating (Đánh giá chuyến bay):")
                        }
                        QGCComboBox {
                            id:         ratingCombo
                            width:      _valueWidth
                            ...
                            model: ListModel {
                                id: ratingItems
                                ListElement { text: qsTr("Vui lòng chọn");            value: "notset"}
                                ListElement { text: qsTr("Crashed (Lỗi của phi công)");    value: "crash_pilot" }
                                ListElement { text: qsTr("Crashed (Vấn đề phần mềm hoặc phần cứng)");   value: "crash_sw_hw" }
                                ListElement { text: qsTr("Không đạt yêu cầu");           value: "unsatisfactory" }
                                ListElement { text: qsTr("Tốt");                     value: "good" }
                                ListElement { text: qsTr("Tuyệt");                    value: "great" }
                            }
                            onActivated: {
                                saveItems();
                    ...
                    //-- Public Log
                    QGCCheckBox {
                        text:       qsTr("Làm cho nhật ký này có sẵn công khai")
                    ...
                    QGCCheckBox {
                        id:         autoUploadCheck
                        text:       qsTr("Kích hoạt tải lên nhật ký tự động")
                    ...
                    QGCCheckBox {
                        text:       qsTr("Xóa tệp nhật ký sau khi tải lên")
                    ...
                    Row {
                        ...
                        QGCButton {
                            ...
                            MessageDialog {
                                ...
                                title:      qsTr("Xóa các tệp nhật ký đã chọn")
                                text:       qsTr("Xác nhận xóa các tệp nhật ký đã chọn?")
                                onYes: {
                        ...
                        QGCButton {
                            text:      qsTr("Tải lên các tệp nhật ký đã chọn")
                            ...
                            MessageDialog {
                                ...
                                standardButtons: StandardButton.Yes | StandardButton.No
                                title:      qsTr("Tải lên các tệp nhật ký đã chọn")
                                text:       qsTr("Xác nhận tải lên các tệp nhật ký đã chọn?")
                                onYes: {
                        ...
                        QGCButton {
                            ...
                            MessageDialog {
                                ...
                                icon:       StandardIcon.Warning
                                standardButtons: StandardButton.Yes | StandardButton.No
                                title:      qsTr("Hủy tải lên")
                                text:       qsTr("Xác nhận hủy quá trình tải lên?")
                                onYes: {
