                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            FactCheckBox {
                                id:             useCheckList
                                text:           qsTr("Sử dụng danh sách kiểm tra trước chuyến bay")
                                fact:           _useChecklist
                            ...
                            FactCheckBox {
                                text:           qsTr("Thực thi danh sách kiểm tra trước chuyến bay")
                            ...
                            FactCheckBox {
                                text:       qsTr("Giữ bản đồ trung tâm trên thiết bị bay")
                            ...
                            FactCheckBox {
                                text:       qsTr("Hiển thị thanh trạng thái phát lại nhật ký truyền thông")
                            ...
                            RowLayout {
                                ...
                                FactCheckBox {
                                    text:       qsTr("Joystik ảo")
                                    visible:    _virtualJoystick.visible
                                    fact:       _virtualJoystick
                                }

                                FactCheckBox {
                                    text:       qsTr("Tự động căn giữa ga")
                            ...
                            FactCheckBox {
                                text:       qsTr("Sử dụng bảng điều khiển công cụ dọc")
                            ...
                            FactCheckBox {
                                text:       qsTr("Hiển thị các chỉ báo hướng bổ sung trên la bàn")
                            ...
                            FactCheckBox {
                                text:       qsTr("Khóa la bàn theo hướng mũi lên")
                            ...
                            FactCheckBox {
                                text:       qsTr("Hiển thị các điều khiển camera đơn giản (DIGICAM_CONTROL)")
                            ...
                            FactCheckBox {
                                text:       qsTr("Cập nhật vị trí nhà dựa trên vị trí thiết bị bay. Điều này sẽ ảnh hưởng đến chức năng quay về nhà (return to home)")
                            ...
                            FactCheckBox {
                                text:       qsTr("Kích hoạt hành động tùy chỉnh")
                            ...
                            GridLayout {
                                ...
                                QGCLabel {
                                    text: qsTr("Định nghĩa hành động tùy chỉnh")
                                ...
                                QGCTextField {
                                    Layout.fillWidth:   true
                                    readOnly:           true
                                    text:               customActions.jsonFile.rawValue === "" ? qsTr("<Chưa được thiết lập>") : customActions.jsonFile.rawValue
                                }
                                QGCButton {
                                    ...
                                    QGCFileDialog {
                                        ...
                                        title:          qsTr("Chọn tệp định nghĩa hành động tùy chỉnh")
                            ...
                            GridLayout {
                                ...
                                QGCLabel {
                                    text:               qsTr("Cài đặt lệnh hướng dẫn")
                                    Layout.columnSpan:  2
                                    Layout.alignment:   Qt.AlignHCenter
                                }

                                QGCLabel {
                                    text:       qsTr("Độ cao tối thiểu")
                                ...
                                QGCLabel {
                                    text:       qsTr("Khoảng cách tối đa đến vị trí")
                            ...
                            GridLayout {
                                ...
                                QGCLabel {
                                    ...
                                    text:       qsTr("Sử dụng bộ nhớ tối đa")
                                ...
                                QGCLabel {
                                    id:         videoDecodeLabel
                                    text:       qsTr("Ưu tiên giải mã video")
                                ...
                                Item { width: 1; height: 1}
                                FactCheckBox {
                                    text:       qsTr("Tự động xóa bản ghi đã lưu")
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                QGCLabel { text: qsTr("Độ cao nhiệm vụ mặc định") }
                                FactTextField {
                                    Layout.preferredWidth:  _valueFieldWidth
                                    fact:                   QGroundControl.settingsManager.appSettings.defaultMissionItemAltitude
                                }

                                QGCLabel { text: qsTr("Khoảng cách chuyển đổi VTOL") }
                                FactTextField {
                                    Layout.preferredWidth:  _valueFieldWidth
                            ...
                            FactCheckBox {
                                text:   qsTr("Sử dụng MAV_CMD_CONDITION_GATE để tạo mẫu")
                                fact:   QGroundControl.settingsManager.planViewSettings.useConditionGate
                            }

                            FactCheckBox {
                                text:       qsTr("Nhiệm vụ không yêu cầu mục cất cánh")
                    ...
                    Rectangle {
                        ...
                        GridLayout {
                            ...
                            Repeater {
                                model: [ qsTr("Khoảng cách ngang"), qsTr("Khoảng cách dọc"), qsTr("Diện tích"), qsTr("Tốc độ"), qsTr("Nhiệt độ") ]
                    ...
                    Rectangle {
                        ...
                        Item {
                            ...
                            GridLayout {
                                ...
                                QGCLabel {
                                    text:                           qsTr("Tỷ lệ giao diện người dùng")
                        ...
                        Item {
                            ...
                            ColumnLayout {
                                ...
                                FactCheckBox {
                                    text:       qsTr("Sử dụng ghép nối thiết bị bay")
                                    fact:       _usePairing
                                ...
                                FactCheckBox {
                                    text:       qsTr("Tắt tất cả âm thanh đầu ra")
                                    fact:       _audioMuted
                                ...
                                FactCheckBox {
                                    text:       qsTr("Lưu dữ liệu ứng dụng vào thẻ SD")
                                ...
                                FactCheckBox {
                                    text:       qsTr("Kiểm tra kết nối Internet")
                                    fact:       _checkInternet
                                ...
                                QGCCheckBox {
                                    id:         clearCheck
                                    text:       qsTr("Xóa tất cả cài đặt khi khởi động lại")
                                    checked:    false
                                    onClicked: {
                                    ...
                                    MessageDialog {
                                        ...
                                        title:              qsTr("Xóa cài đặt")
                                        text:               qsTr("Tất cả cài đặt đã lưu sẽ được đặt lại khi bạn khởi động %1 lần sau. Đây có phải là điều bạn muốn không?").arg(QGroundControl.appName)
                                        onYes: {
                        ...
                        RowLayout {
                            ...
                            QGCLabel { text: qsTr("Đường dẫn Tải/Lưu Ứng dụng") }
                            QGCTextField {
                                Layout.fillWidth:   true
                                readOnly:           true
                            ...
                            QGCButton {
                                ...
                                QGCFileDialog {
                                    ...
                                    title:          qsTr("Chọn vị trí để lưu/tải tệp")
                    ...
                    QGCLabel {
                        ...
                        text:       qsTr("Nhật ký truyền thông từ thiết bị bay")
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            FactCheckBox {
                                id:         promptSaveLog
                                text:       qsTr("Lưu nhật ký sau mỗi chuyến bay")
                                fact:       _telemetrySave
                            ...
                            FactCheckBox {
                                id:         logIfNotArmed
                                text:       qsTr("Lưu nhật ký ngay cả khi thiết bị bay không armed")
                            ...
                            FactCheckBox {
                                id:         promptSaveCsv
                                text:       qsTr("Lưu nhật ký CSV của dữ liệu truyền thông")
                    ...
                    QGCLabel {
                        ...
                        text:       qsTr("Tự động kết nối với các thiết bị sau")
                    ...
                    Rectangle {
                        ...
                        GridLayout {
                            ...
                            Item { width: rtkGrid.firstColWidth; height: 1 }
                            QGCButton {
                                text:               qsTr("Lưu vị trí gốc hiện tại")
                    ...
                    Rectangle {
                        ...
                        QGCLabel {
                            ...
                            text:               qsTr("Lưu ý: Các cài đặt này không dành cho việc sử dụng với bộ phát đáp ADSB được đặt trên thiết bị bay.")
                        }
                    ...
                    QGCLabel {
                        ...
                        text:       qsTr("Hình ảnh thương hiệu")
                        ...
                        GridLayout {
                            ...
                            QGCButton {
                                ...
                                QGCFileDialog {
                                    ...
                                    title:              qsTr("Chọn tệp hình ảnh thương hiệu tùy chỉnh")
                            ...
                            QGCButton {
                                text:               qsTr("Đặt lại hình ảnh thương hiệu mặc định")
                                Layout.columnSpan:  3
                                Layout.alignment:   Qt.AlignHCenter
                                onClicked:  {
                    ...
                    QGCLabel {
                        text:               qsTr("Phiên bản 1.0 %1").arg(QGroundControl.appName)
                        Layout.alignment:   Qt.AlignHCenter
                    }
                    QGCLabel {
