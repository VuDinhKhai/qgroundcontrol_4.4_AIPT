        ...
        Rectangle {
            ...
            Column {
                ...
                GridLayout {
                    ...
                    Image {
                        ...
                        QGCLabel {
                            anchors.fill:           parent
                            text:                   commsFlag ? qsTr("GIAO TIẾP RID") : qsTr("KHÔNG CÓ KẾT NỐI")
                            wrapMode:               Text.WordWrap
                            horizontalAlignment:    Text.AlignHCenter
                            verticalAlignment:      Text.AlignVCenter
                            font.bold:              true
            ...
            Item {
                ...
                QGCLabel {
                    ...
                    text:                   emergencyDeclared ? qsTr("TÌNH HUỐNG KHẨN CẤP ĐÃ ĐƯỢC KÍCH HOẠT, Nhấn và giữ trong 3 giây để hủy bỏ") : qsTr("Nhấn và giữ nút bên dưới để kích hoạt tình huống khẩn cấp")
                    font.family:            ScreenTools.demiboldFontFamily
                    anchors.top:            parent.top
                    anchors.left:           parent.left
                    anchors.right:          parent.right
                ...
                Image {
                    ...
                    QGCLabel {
                        anchors.fill:           parent
                        text:                   emergencyDeclared ? qsTr("Hủy tình huống khẩn cấp") : qsTr("KHẨN CẤP")
                        wrapMode:               Text.WordWrap
                        horizontalAlignment:    Text.AlignHCenter
                        verticalAlignment:      Text.AlignVCenter
                        font.bold:              true
