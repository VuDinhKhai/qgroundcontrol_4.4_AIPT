            ...
            GridLayout {
                ...
                Repeater {
                    ...
                    model: [
                        ...
                        {id: "acqControl", text: hasControl ? qsTr("Giải phóng <br> Điều khiển") : qsTr("Lấy <br> Điều khiển"), visible: acqControlButtonEnabled }
                    ]
                ...
                QGCLabel {
                    text:                   qsTr("Kích hoạt <br> Gimbal: ") + activeGimbal.deviceId.rawValue
                    font.pointSize:         ScreenTools.smallFontPointSize
                    Layout.preferredWidth:  buttonHeight * 1.1
                    Layout.leftMargin:      margins
                    font.weight:            Font.Medium
                ...
                GridLayout {
                    ...
                    QGCLabel {
                        text:               qsTr("Góc nhìn theo phương ngang")
                    ...
                    QGCLabel {
                        text:               qsTr("Góc nhìn theo phương thẳng đứng")
                        visible:            enableOnScreenControlCheckbox.checked && QGroundControl.settingsManager.gimbalControllerSettings.ControlType.rawValue === 0
                    }
                    FactTextField {
                    ...
                    FactCheckBox {
                        ...
                        text:               "  " + qsTr("Hiển thị chỉ báo phương vị gimbal trên bản đồ")
                    ...
                    FactCheckBox {
                        ...
                        text:               "  " + qsTr("Sử dụng phương vị thay vì góc xoay địa phương trên chỉ báo thanh công cụ trên cùng")
                    ...
                    FactCheckBox {
                        ...
                        text:               "  " + qsTr("Hiển thị nút Lấy/ Giải phóng điều khiển")
    ...
    GridLayout {
        ...
        QGCLabel {
            ...
            text:                   activeGimbal && activeGimbal.retracted ? 
                                        qsTr("Thu lại") :
                                        (activeGimbal && activeGimbal.yawLock ? qsTr("Góc xoay (yaw) đã khóa") : qsTr("Theo dõi góc xoay (yaw)"))
            Layout.columnSpan:      2
