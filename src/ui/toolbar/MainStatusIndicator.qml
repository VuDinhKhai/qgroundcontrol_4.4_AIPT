...
RowLayout {
    ...
    QGCLabel {
        ...
        property string _commLostText:      qsTr("Mất liên lạc")
        property string _readyToFlyText:    qsTr("Sẵn sàng bay")
        property string _notReadyToFlyText: qsTr("Chưa sẵn sàng")
        property string _disconnectedText:  qsTr("Đã ngắt kết nối")
        property string _armedText:         qsTr("kích hoạt hệ thống")
        property string _flyingText:        qsTr("Đang bay")
        property string _landingText:       qsTr("Hạ cánh")
            ...
            QGCFlickable {
                ...
                ColumnLayout {
                    ...
                    QGCButton {
                        ...
                        //text:               _armed ?  qsTr("Tắt trạng thái sẵn sàng") : (forceArm ? qsTr("Kích hoạt trạng thái sẵn sàng bất chấp điều kiện kiểm tra an toàn thông thường ") : qsTr("Kích hoạt trạng thái sẵn sàng"))
                    ...
                    QGCLabel {
                        text:               qsTr("Báo cáo kiểm tra kích hoạt:")
    ...
    Component {
        ...
        Rectangle {
            ...
            QGCButton {
                ...
                anchors.top:        parent.top
                anchors.left:       parent.left
                text:               _vtolInFWDFlight ? qsTr("Chuyển đổi sang nhiều cánh quạt") : qsTr("Chuyển sang cánh cố định")
