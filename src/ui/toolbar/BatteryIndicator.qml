                    ...
                    ColumnLayout {
                        Repeater {
                            ...
                            ColumnLayout {
                                ...
                                QGCLabel { text: qsTr("Pin %1").arg(object.id.rawValue) }
                                QGCLabel { text: qsTr("Trạng thái sạc");                          visible: batteryValuesAvailable.chargeStateAvailable }
                                QGCLabel { text: qsTr("Còn lại");                             visible: batteryValuesAvailable.timeRemainingAvailable }
                                QGCLabel { text: qsTr("Còn lại") }
                                QGCLabel { text: qsTr("Điện áp") }
                                QGCLabel { text: qsTr("Đã tiêu thụ");                              visible: batteryValuesAvailable.mahConsumedAvailable }
                                QGCLabel { text: qsTr("Nhiệt độ");                           visible: batteryValuesAvailable.temperatureAvailable }
                                QGCLabel { text: qsTr("Chức năng");                              visible: batteryValuesAvailable.functionAvailable }
                            }
                        }
                    }
