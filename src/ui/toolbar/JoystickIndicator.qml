    ...
    Component {
        ...
        Rectangle {
            ...
            Column {
                ...
                QGCLabel {
                    id:             joystickLabel
                    text:           qsTr("Trạng thái tay điều khiển")
                ...
                GridLayout {
                    ...
                    QGCLabel { text: qsTr("Đã kết nối:") }
                    QGCLabel {
                        text:  joystickManager.activeJoystick ? qsTr("Có") : qsTr("Không")
                        color: joystickManager.activeJoystick ? qgcPal.buttonText : "red"
                    }
                    QGCLabel { text: qsTr("Enabled:") }
                    QGCLabel {
                        text:  globals.activeVehicle && globals.activeVehicle.joystickEnabled ? qsTr("Có") : qsTr("Không")
