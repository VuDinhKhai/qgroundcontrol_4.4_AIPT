    ...
    Component {
        ...
        Rectangle {
            ...
            Column {
                ...
                QGCLabel {
                    id:             gpsLabel
                    text: (QGroundControl.gpsRtk.active.value) ? qsTr("Chế độ khảo sát đang hoạt động") : qsTr("Truyền phát RTK")
                ...
                GridLayout {
                    ...
                    QGCLabel {
                        ...
                        text: QGroundControl.gpsRtk.valid.value ? qsTr("Độ chính xác:") : qsTr("Độ chính xác hiện tại:")
