...
Rectangle {
    ...
    readonly property string    _armedVehicleText:  qsTr("Không thể thực hiện thao tác này khi thiết bị bay đang ở chế độ sẵn sàng (armed)")
    ...
    property string _messagePanelText:              qsTr("Văn bản bảng tin nhắn bị thiếu")
    ...
    function showVehicleComponentPanel(vehicleComponent)
    {
        ...
        if (prereq !== "") {
            _messagePanelText = qsTr("Cài đặt %1 phải được hoàn thành trước khi cài đặt %2.").arg(prereq).arg(vehicleComponent.name)
    ...
    Component {
        ...
        Rectangle {
            ...
            QGCLabel {
                ...
                text:                   qsTr("%1 hiện tại không hỗ trợ cài đặt cho loại phương tiện bay của bạn.").arg(QGroundControl.appName) +
    ...
    Component {
        ...
        Rectangle {
            ...
            QGCLabel {
                ...
                text:                   qsTr("Cài đặt và thông tin thiết bị bay sẽ được hiển thị sau khi kết nối thiết bị bay của bạn.") +
                                        (ScreenTools.isMobile || !_corePlugin.options.showFirmwareUpgrade ? "" : "Nhấp vào Firmware ở bên trái để nâng cấp xe của bạn.")
    ...
    Component {
        ...
        Rectangle {
            ...
            QGCLabel {
                ...
                text: qsTr("Hiện tại bạn đã kết nối với một thiết bị bay, nhưng thiết bị không trả lại đầy đủ danh sách tham số. ") +
                    qsTr("Do đó, các tùy chọn cài đặt đầy đủ của thiết bị bay không có sẵn.")
    ...
    QGCFlickable {
        ...
        ColumnLayout {
            ...
            SubMenuButton {
                ...
                text:               _forcedToButtonsOnly ? qsTr("Nút bấm") : qsTr("Joystick")
                Layout.fillWidth:   true
