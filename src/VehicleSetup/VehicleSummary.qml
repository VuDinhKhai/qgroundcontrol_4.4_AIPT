    ...
    QGCFlickable {
        ...
        Column {
            ...
            QGCLabel {
                ...
                text:           setupComplete ?
                    qsTr("Dưới đây là tóm tắt các cài đặt cho thiết bị bay của bạn. Bên trái là các menu thiết lập cho từng thành phần.") :
                    qsTr("CẢNH BÁO: Thiết bị bay của bạn cần được thiết lập trước khi bay. Vui lòng giải quyết các mục được đánh dấu màu đỏ bằng cách sử dụng menu bên trái.")
