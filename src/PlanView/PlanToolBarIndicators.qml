...
Item {
    ...
    property string _gradientText:              isNaN(_gradient) ?              "-.-" : _gradient.toFixed(0) + qsTr("độ")
    ...
    GridLayout {
        ...
        QGCButton {
            id:          uploadButton
            text:        _controllerDirty ? qsTr("Cần tải lên") : qsTr("Tải lên")
    ...
    Rectangle {
        ...
        QGCLabel {
            ...
            text:               qsTr("Đang đồng bộ nhiệm vụ")
            font.pointSize:     ScreenTools.largeFontPointSize
        }
        ...
        QGCLabel {
            ...
            anchors.right:      parent.right
            anchors.bottom:     parent.bottom
            text:               qsTr("Nhấn vào bất kỳ đâu để ẩn")
