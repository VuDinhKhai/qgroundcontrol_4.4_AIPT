...
Rectangle {
    ...
    readonly property string _vehicleLabel:     qsTr("Thiết bị bay")
    ...
    ColumnLayout {
        ...
        Column {
            ...
            QGCLabel {
                anchors.left:           parent.left
                anchors.right:          parent.right
                text:                   qsTr("Các lệnh camera trên sẽ có hiệu lực ngay khi nhiệm vụ bắt đầu.")
            ...
            SectionHeader {
                ...
                anchors.left:   parent.left
                anchors.right:  parent.right
                text:           qsTr("Thông tin thiết bị bay")
            ...
            GridLayout {
                ...
                QGCLabel {
                    ...
                    wrapMode:               Text.WordWrap
                    font.pointSize:         ScreenTools.smallFontPointSize
                    text:                   qsTr("Các giá trị tốc độ sau được sử dụng để tính thời gian thực hiện nhiệm vụ tổng thể. Chúng không ảnh hưởng đến tốc độ bay trong nhiệm vụ.")
            ...
            Column {
                ...
                QGCLabel {
                    ...
                    wrapMode:               Text.WordWrap
                    font.pointSize:         ScreenTools.smallFontPointSize
                    text:                   qsTr("Vị trí thực tế được thiết bị bay thiết lập tại thời gian bay.")
                    horizontalAlignment:    Text.AlignHCenter
                }

                QGCButton {
                    text:                       qsTr("Đặt về trung tâm bản đồ")
