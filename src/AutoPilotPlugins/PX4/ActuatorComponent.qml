        ...
        Row {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    QGCLabel {
                        text:                   qsTr("Hình học") + (actuators.mixer.title ? ": " + actuators.mixer.title : "")
                ...
                // actuator testing
                QGCLabel {
                    text:               qsTr("Kiểm tra cơ cấu chấp hành")
                    font.pointSize:     ScreenTools.mediumFontPointSize
                }
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        QGCLabel {
                            text: qsTr("Cấu hình một số đầu ra để kiểm tra chúng")
                        ...
                        Row {
                            ...
                            QGCLabel {
                                ...
                                text: safetySwitch.checked ? qsTr("Cẩn thận: Các thanh trượt cơ cấu chấp hành đã được bật") : qsTr("Cánh quạt đã được tháo ra - Bật các thanh trượt")
                            }
                        } // Row
            ...
            Column {
                QGCLabel {
                    text:               qsTr("Đầu ra cơ cấu chấp hành")
                    font.pointSize:     ScreenTools.mediumFontPointSize
                    bottomPadding:      ScreenTools.defaultFontPixelHeight
                }
                QGCLabel {
                    text:          qsTr("Một hoặc nhiều cơ cấu chấp hành vẫn cần được gán vào một đầu ra.")
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            spacing:           _margins
                            QGCButton {
                                text:          qsTr("Xác định và Gán động cơ")
                                ...
                                MessageDialog {
                                    ...
                                    title:      qsTr("Xác định và Gán thứ tự động cơ")
