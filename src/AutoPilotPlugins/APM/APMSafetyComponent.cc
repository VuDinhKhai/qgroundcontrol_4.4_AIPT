...
QString APMSafetyComponent::description(void) const
{
    ...
    case MAV_TYPE_SUBMARINE:
        return tr("Thiết lập An toàn được sử dụng để thiết lập các hành động an toàn, phát hiện rò rỉ, và các kiểm tra vũ trang.");
        break;
    ...
    default:
        return tr("Thiết lập An toàn được sử dụng để thiết lập các kích hoạt cho Trở về Đất cũng như các cài đặt cho Trở về Đất chính nó.");
        break;
    }
}
