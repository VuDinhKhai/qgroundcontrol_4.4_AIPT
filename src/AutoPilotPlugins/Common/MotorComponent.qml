    ...
    Component {
        ...
        Column {
            ...
            QGCLabel {
                ...
                text:           qsTr("Di chuyển thanh trượt sẽ khiến động cơ quay. Hãy chắc chắn bạn đã tháo tất cả cánh quạt.")
            }
            ...
            Row {
                ...
                QGCLabel {
                    color:  qgcPal.warningText
                    text:   safetySwitch.checked ? qsTr("Cẩn thận: Thanh trượt động cơ đã được kích hoạt") : qsTr("Cánh quạt đã được tháo - Kích hoạt thanh trượt động cơ")
                }
            } // Row
        } // Column
    } // Component
