...
FirstRunPrompt {
    ...
    property var    _rgLabels:          [ qsTr("Khoảng cách ngang"), qsTr("Khoảng cách dọc"), qsTr("Diện tích"), qsTr("Tốc độ"), qsTr("Nhiệt độ") ]
    ...
    ColumnLayout {
        ...
        QGCLabel {
            ...
            text:       qsTr("Chọn đơn vị đo lường bạn muốn sử dụng. Bạn cũng có thể thay đổi nó sau trong Cài đặt chung.")
        ...
        Rectangle {
            ...
            GridLayout {
                ...
                QGCLabel { text: qsTr("Hệ thống đơn vị") }
                ...
                QGCComboBox {
                    Layout.fillWidth:   true
                    sizeToContents:     true
                    model:              [ qsTr("Hệ thống đo lường mét"), qsTr("Hệ thống đơn vị Anh") ]
