...
WindowsBuild {
    RC_ICONS = resources/icons/AIPT_UAV.ico
...
QGC_APP_NAME        = "AIPTControlMaster"
QGC_ORG_NAME        = "QGroundControl.org"
QGC_ORG_DOMAIN      = "org.qgroundcontrol"
QGC_APP_DESCRIPTION = "Ứng dụng điều khiển mặt đất được cung cấp bởi nhóm phát triển AIPT UAV"
QGC_APP_COPYRIGHT   = "."

WindowsBuild {
    QGC_INSTALLER_SCRIPT        = "$$SOURCE_DIR\\deploy\\windows\\nullsoft_installer.nsi"
    QGC_INSTALLER_ICON          = "$$SOURCE_DIR\\deploy\\windows\\AIPT_UAV.ico"
